...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.user_ip'
        db.add_column(u'blogsimple_comment', 'user_ip',
                      self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True),
                      keep_default=False)

        # Adding field 'Comment.user_agent'
        db.add_column(u'blogsimple_comment', 'user_agent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.user_ip'
        db.delete_column(u'blogsimple_comment', 'user_ip')

        # Deleting field 'Comment.user_agent'
        db.delete_column(u'blogsimple_comment', 'user_agent')
