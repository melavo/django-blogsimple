...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blogsimple_reaction', 'user_url', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reaction.user_url'
        db.delete_column('blogsimple_reaction', 'user_url')
