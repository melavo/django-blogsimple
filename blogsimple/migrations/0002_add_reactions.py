...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blogsimple_reaction', (
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('comment_for', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blogsimple.BlogEntry'])),
        ...
        db.send_create_signal('blogsimple', ['Reaction'])

        # Adding field 'BlogEntry.text_markup_type'
        db.add_column('blogsimple_blogentry', 'text_markup_type', self.gf('django.db.models.fields.CharField')(default='markdown', max_length=30), keep_default=False)

        # Adding field 'BlogEntry._text_rendered'
        db.add_column('blogsimple_blogentry', '_text_rendered', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Changing field 'BlogEntry.text'
        db.alter_column('blogsimple_blogentry', 'text', self.gf('markupfield.fields.MarkupField')())


    def backwards(self, orm):
        
        # Deleting model 'Reaction'
        db.delete_table('blogsimple_reaction')

        # Deleting field 'BlogEntry.text_markup_type'
        db.delete_column('blogsimple_blogentry', 'text_markup_type')

        # Deleting field 'BlogEntry._text_rendered'
        db.delete_column('blogsimple_blogentry', '_text_rendered')

        # Changing field 'BlogEntry.text'
        db.alter_column('blogsimple_blogentry', 'text', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'blogsimple.comment': {
            ...
            'comment_for': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blogsimple.BlogEntry']"}),
