...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blogsimple_blogentry', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'BlogEntry.slug'
        db.alter_column(u'blogsimple_blogentry', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
