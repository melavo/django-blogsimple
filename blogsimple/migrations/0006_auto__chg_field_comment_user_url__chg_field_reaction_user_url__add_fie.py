...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.user_url'
        db.alter_column(u'blogsimple_comment', 'user_url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Reaction.user_url'
        db.alter_column(u'blogsimple_reaction', 'user_url', self.gf('django.db.models.fields.URLField')(max_length=200))
        # Adding field 'BlogEntry.publish_date'
        db.add_column(u'blogsimple_blogentry', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'BlogEntry.text'
        db.alter_column(u'blogsimple_blogentry', 'text', self.gf('markupfield.fields.MarkupField')(rendered_field=True))

        # Changing field 'BlogEntry.created_on'
        db.alter_column(u'blogsimple_blogentry', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Comment.user_url'
        db.alter_column(u'blogsimple_comment', 'user_url', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Reaction.user_url'
        db.alter_column(u'blogsimple_reaction', 'user_url', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'BlogEntry.publish_date'
        db.delete_column(u'blogsimple_blogentry', 'publish_date')


        # Changing field 'BlogEntry.text'
        db.alter_column(u'blogsimple_blogentry', 'text', self.gf('markupfield.fields.MarkupField')())

        # Changing field 'BlogEntry.created_on'
        db.alter_column(u'blogsimple_blogentry', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'blogsimple.comment': {
            'Meta': {'ordering': "['created_on']", 'object_name': 'Comment'},
            'comment_for': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blogsimple.BlogEntry']"}),
