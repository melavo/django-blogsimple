...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Blog'
        db.create_table('blogsimple_blog', (
        ...
        db.send_create_signal('blogsimple', ['Blog'])

        # Adding model 'BlogEntry'
        db.create_table('blogsimple_blogentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('blogsimple', ['BlogEntry'])

        # Adding model 'Comment'
        db.create_table('blogsimple_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal('blogsimple', ['Comment'])

        # Adding model 'BlogRoll'
        db.create_table('blogsimple_blogroll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
        ))
        db.send_create_signal('blogsimple', ['BlogRoll'])


    def backwards(self, orm):
        
        # Deleting model 'Blog'
        db.delete_table('blogsimple_blog')

        # Deleting model 'BlogEntry'
        db.delete_table('blogsimple_blogentry')

        # Deleting model 'Comment'
        db.delete_table('blogsimple_comment')

        # Deleting model 'BlogRoll'
        db.delete_table('blogsimple_blogroll')
