...
from blogsimple.views import _get_archive_months
from blogsimple.models import Blog, BlogEntry

register = template.Library()

class blogsimpleContext(template.Node):
    def __init__(self):
        pass
    ...
    def render(self, context):
        ...
        feed_url = reverse('blogsimple_feed')
...
def blogsimple_extra_context(parser, token):
    return blogsimpleContext()
...
register.tag('blogsimple_extra_context', blogsimple_extra_context)
